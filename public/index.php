...
<div class="container mt-4">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
        ...
        if (!empty($nombre) && !empty($producto) && $valor > 0) {
            $sql = "INSERT INTO Usuarios (nombre, producto, valor) VALUES ('$nombre', '$producto', $valor)";
    ...
    echo '<thead><tr><th>ID</th><th>Nombre</th><th>Producto</th><th>Valor</th></tr></thead>';
